...
1. 	Repeat the questions until you have successfully studied more than 5 times
	...
	Hint: create an equation to add the number of times they studied.
    The variable will be constantly checked in the while loop.
	Once they have studied more than 5 times, you can stop repeating the questions and say,
    “Congratulations, you are going to kill your exam!”
"""
)
A = "n"
B = 0
