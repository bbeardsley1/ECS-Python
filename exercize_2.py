...
6.  It is 8:45pm and Sam is tired but still has homework to do. 
    Sam's plan is to sleep for a while, then get up and do the homework. 
    Sam is too tired to figure out the time to set the alarm clock,
    so needs you to write a Python program that asks how many hours and minutes of sleep Sam needs,
    and then prints out the time to set the alarm clock. 
